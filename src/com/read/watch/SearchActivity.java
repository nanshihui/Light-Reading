 ...
 */
public class SearchActivity extends Activity implements OnHeaderRefreshListener,OnFooterRefreshListener,OnClickListener{
		...
		listView.setAdapter(adapter);
		 ...
		 mPullToRefreshView.setOnHeaderRefreshListener(this);
	       ...
	       listView.setOnItemClickListener(new OnItemClickListener() {
				...
				{
					Toast.makeText(SearchActivity.this, "已经触发", Toast.LENGTH_LONG).show();

					  Intent intent = new Intent(SearchActivity.this,DetailuploadActivity.class);
		...
		mPullToRefreshView.postDelayed(new Runnable() {
			...
			public void run() {
		      ...
		      //  String time=new SimpleDateFormat("yyyyMMddHHmmss").format(new Date());
				...
				Toast.makeText(SearchActivity.this, time, Toast.LENGTH_LONG).show();
	...
	public class LoadUploadnewAsyncTask extends AsyncTask<Object, Integer, Integer>
	{
		...
		protected void onPostExecute(Integer result)
		{
			...
			{
			case NONEWS:
				Toast.makeText(SearchActivity.this, "没有消息", Toast.LENGTH_LONG).show();break;
			case NOMORENEWS:
				Toast.makeText(SearchActivity.this, "没有更多消息", Toast.LENGTH_LONG).show();break;
			case LOADERROR:
				Toast.makeText(SearchActivity.this, "读取消息失败", Toast.LENGTH_LONG).show();break;
			}
			adapter.notifyDataSetChanged();
	...
	public void onClick(View v) {
		...
		{
		case R.id.refresh: 
			Toast.makeText(SearchActivity.this, "出发了", Toast.LENGTH_LONG).show();
